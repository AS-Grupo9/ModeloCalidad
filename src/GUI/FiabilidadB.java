...
public class FiabilidadB {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					/*FiabilidadB window = new FiabilidadB();
	 ...
	 */
	public FiabilidadB(Splash frameInicial) {
		...
		JLabel lblALuegoDe = new JLabel("b) Luego de ocurrir un error en el sistema, \u00BFSe genera un log de errores?");
		...
		rdbtnMalo.setBounds(114, 29, 109, 23);
		...
		rdbtnBueno.setBounds(247, 29, 109, 23);
