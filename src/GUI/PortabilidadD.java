...
public class PortabilidadD {
	 ...
	 */
	public PortabilidadD(Splash frameInicial) {
		...
		btnSiguiente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(pregunta > 0)
				{
					...
					PortabilidadE porE = new PortabilidadE(frameInicial);
		...
		JLabel lblFuncionabilidad = new JLabel("PORTABILIDAD - Instabilidad");
		...
		JLabel lblALuegoDe = new JLabel("<html>b) ¿La instalación posee opciones para cambiar el directorio de instalación?</html>");
