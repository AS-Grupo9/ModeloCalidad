...
public class FuncionabilidadC {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FuncionabilidadC window = new FuncionabilidadC();
	...
	private void initialize() {
		...
		JLabel lblALuegoDe = new JLabel("c) \u00BFExisten restricciones de accesos a funcionalidades de acuerdo a alg\u00FAn rol de usuario?");
