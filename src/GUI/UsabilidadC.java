...
public class UsabilidadC {
	 ...
	 */
	public UsabilidadC(Splash frameInicial) {
		...
		btnSiguiente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(pregunta > 0)
				{
					...
					UsabilidadD usaD = new UsabilidadD(frameInicial);
		...
		JLabel lblALuegoDe = new JLabel("<html>c) ¿El sistema posee manual con un menú dedicado en el sistema?</html>");
