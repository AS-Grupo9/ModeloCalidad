...
public class UsabilidadA {
	 ...
	 */
	public UsabilidadA(Splash frameInicial) {
		...
		btnSiguiente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(pregunta > 0)
				{
					...
					UsabilidadB usaB = new UsabilidadB(frameInicial);
		...
		JLabel lblALuegoDe = new JLabel("<html>a) ¿El sistema posee ayuda contextual sobre menús y botones de acción?</html>");
