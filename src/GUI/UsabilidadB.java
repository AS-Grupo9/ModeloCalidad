...
public class UsabilidadB {
	 ...
	 */
	public UsabilidadB(Splash frameInicial) {
		...
		JLabel lblALuegoDe = new JLabel("<html>b) ¿El sistema posee mensajes de error, al ingresar datos inválidos? </html>");
