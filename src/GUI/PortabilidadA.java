...
public class PortabilidadA {
	 ...
	 */
	public PortabilidadA(Splash frameInicial) {
		...
		btnSiguiente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(pregunta > 0)
				{
					...
					PortabilidadB porB = new PortabilidadB(frameInicial);
		...
		JLabel lblALuegoDe = new JLabel("<html>a) ¿El sistema posee la capacidad de adaptarse a diferentes sistemas operativos sin modificar su estructura interna? </html>");
